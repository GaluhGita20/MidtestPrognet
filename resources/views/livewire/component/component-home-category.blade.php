            ...
            <div class="product__catagory">
              ...
              <div class="product__catagory--single">
                ...
                <div class="product__content product__content--catagory">
                  ...
                  <span class="product__items--text">{{$category->products->count()}} Products</span>
                </div> <!-- End Product Content -->
                <!-- Start Product Image -->
                <div class="product__img-box product__img-box--catagory">
                  <a href="product-single-default.html" class="product__img--link">
                    <img class="product__img img-fluid" src="{{ URL::asset('asset/kategori/' . $category->gambar) }}" alt="" style="position:absolute; top:0; right:0; width:40%;height:100%" >
                  </a>
