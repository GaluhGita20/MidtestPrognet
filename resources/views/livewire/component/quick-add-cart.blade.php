            ...
            <div class="col-md-6 modal__border">    
              <div class="product-details-box">
                ...
                <div class="product__price">
                    <!-- <del><span class="product__price-del">$35.90</span></del> -->
                    <!-- Harga Product -->
                ...
                <div class="product-var p-t-30">
                  <div class="product-quantity product-var__item d-flex align-items-center flex-wrap">
                    ...
                    <form class="modal-quantity-scale m-l-20">
                      ...
                      <input name="qty_product" type="number" class="input_qty_product_cart" id="modal-number" value="1" >
              ...
              <div class="modal__product-cart-buttons m-tb-15">
                  ...
                  <button type="submit" class="btn btn--box  btn--tiny btn--green btn--green-hover-black btn--uppercaset">Checkout</button>
              </div>
            </div>           
          </div>
        </div>
