      ...
      <div class="table-responsive">
        <table class="table table-striped table-responsive-sm">
          ...
          <tr>
            ...
            <td colspan="1">{{$product->product_category->category_name}}</td>
            <td colspan="1"><img src="{{ URL::asset('asset/product/'. $product->gambar) }}"alt="{{ $product->gambar }}" width="200px" height="150px" style="border-radius:0px;"></td>
